...
public interface ItCaseIdDaoImpl {
	/**
	 * ��������:�޸�����
	 * author:wy
	 * date:2016��4��15��
 ...
 * @return
 */
public int addItCase(String file1,String backcase,String caseNo, int cid,  String content,
		String saleName, String saleName1, String projectDesce,
		String projectDescc, int ddlType, String orderGroup,
		String customerGroup, int ddlSelectPriceDays,String time, String quotername);
...
/**
 * 
 * @Title:ItCaseIdDaoImpl
 * @Description:根据项目号获取项目需求
   @author wangyang
 * @param projectNo
 * @return String
 * @throws
...
public List<FactoryReconciliation> factoryPayInfo(String invoiceName);
	...
	public List<FactoryReconciliation> getPayInfo(String invoiceName);

	public List<FactoryReconciliation> factoryPayInfoDetail(String invoiceName,int flag);
