...
public interface IAccountEntryFormDao {
	/**
	 * 
	 ...
	 * @throws
	 */
	ArrivalAccountCorrespondenceTable ArrivalAccountCorrespondenceTable(
			String payersName);
	/**
	 * 
	 ...
	 * @throws
	 */
	AccountEntryForm AccountEntryForm(int id);
	/**
	 * 
	 * @Title:IAccountEntryFormDao
	 * @Description:获取id
	 ...
	 * @throws
	 */
	int insertSecondSumMoney(int id, double secondSumMoney);
	/**
	 * 
	 * @Title:IAccountEntryFormService
