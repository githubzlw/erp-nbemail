...
import cerong.erp.util.MyProgressListener;
...
public class MyFileUpLoad {
	private static final Logger LOG = LoggerFactory.getLogger(MyFileUpLoad.class);
		...
		*//**
		...
		try {
			...
			/*byte[] buffer = new byte[1024];  
		       ...
		       String strZipName = path+File.separator+value.substring(0,value.lastIndexOf(".")) +".zip";  
			...
			map.put(name,value.substring(0,value.lastIndexOf("."))+".zip" );*/
				}	
			}
